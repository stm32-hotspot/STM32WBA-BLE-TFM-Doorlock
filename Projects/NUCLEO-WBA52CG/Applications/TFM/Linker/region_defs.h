...
#else
#define LOADER_NS_CODE_SIZE                 (0x0)
#endif /*defined(MCUBOOT_EXT_LOADER)*/
...
#define S_DATA_IMAGE_IAT_PRIV_KEY_SIZE      (32)

#define S_DATA_IMAGE_DOORLOCK_KEY           (BL2_DATA_HEADER_SIZE+S_DATA_IMAGE_IAT_PRIV_KEY_SIZE)
#define S_DATA_IMAGE_DOORLOCK_KEY_SIZE      (32)
#endif /* (MCUBOOT_S_DATA_IMAGE_NUMBER == 1) */
