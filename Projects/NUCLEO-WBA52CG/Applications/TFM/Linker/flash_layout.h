...
#else
#define FLASH_AREA_SCRATCH_SIZE         (0x2000) /* 8 KB */
#endif
...
/* BL2 partitions size */
#define FLASH_S_PARTITION_SIZE          (0x32000) /* 205 KB for S partition */
#if !defined(MCUBOOT_PRIMARY_ONLY)
#define FLASH_NS_PARTITION_SIZE         (0x38000) /* 229 KB for NS partition */
#else
#define FLASH_NS_PARTITION_SIZE         (0x32000) /* 205 KB for NS partition */
