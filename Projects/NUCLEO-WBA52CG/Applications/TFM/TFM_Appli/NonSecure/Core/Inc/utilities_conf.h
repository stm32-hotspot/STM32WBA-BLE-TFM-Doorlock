...
/**
  * @brief macro used to enter the critical section
  */
#define UTILS_ENTER_CRITICAL_SECTION() uint32_t primask_bit=INTERFACE_TFM_RADIOSERVERICE_DisableIrqWithdirectRestore();

/**
  * @brief macro used to exit the critical section
  */
#define UTILS_EXIT_CRITICAL_SECTION()  INTERFACE_TFM_RADIOSERVERICE_SetPrimask(primask_bit);

/**
  * @brief macro used to enter the critical section
  */
#define UTILS_ENTER_LIMITED_CRITICAL_SECTION(x) uint32_t basepri_value= __get_BASEPRI();\
  INTERFACE_TFM_RADIOSERVERICE_SetBasepri(x);\
  __set_BASEPRI_MAX(x)

/**
  * @brief macro used to exit the critical section
  */
#define UTILS_EXIT_LIMITED_CRITICAL_SECTION() INTERFACE_TFM_RADIOSERVERICE_SetBasepri(basepri_value);\
