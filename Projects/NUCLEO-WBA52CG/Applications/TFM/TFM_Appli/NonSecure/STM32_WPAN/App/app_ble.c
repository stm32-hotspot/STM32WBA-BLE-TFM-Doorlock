...
DLS_APP_ConnHandleNotEvt_t DLSHandleNotification;
OTA_APP_ConnHandleNotEvt_t OTAHandleNotification;

static const char a_GapDeviceName[] = {  'D', 'o', 'o', 'r', 'L', 'o', 'c', 'k', 'M', 'X' }; /* Gap Device Name */
...
{
  6, AD_TYPE_COMPLETE_LOCAL_NAME, 'D', 'L', '_', 'X', 'X',  /* Complete name */
...
SVCCTL_UserEvtFlowStatus_t SVCCTL_App_Notification(void *p_Pckt)
{
  ...
  switch (p_event_pckt->evt)
  {
    case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
    {
      ...
      DLSHandleNotification.EvtOpcode = DLS_DISCON_HANDLE_EVT;
      ...
      DLSHandleNotification.ConnectionHandle = bleAppContext.BleApplicationContext_legacy.connectionHandle;
      OTAHandleNotification.ConnectionHandle = bleAppContext.BleApplicationContext_legacy.connectionHandle;
      DIS_APP_EvtRx(&DISHandleNotification);
      DLS_APP_EvtRx(&DLSHandleNotification);
    ...
    case HCI_LE_META_EVT_CODE:
    {
      ...
      switch (p_meta_evt->subevent)
      {
        ...
        case HCI_LE_ENHANCED_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          DLSHandleNotification.EvtOpcode = DLS_CONN_HANDLE_EVT;
...
void APP_BLE_Procedure_Gap_Peripheral(ProcGapPeripheralId_t ProcGapPeripheralId)
{
  ...
  switch(ProcGapPeripheralId)
  {
    ...
    {
      APP_DBG_MSG("PROC_GAP_PERIPH_ADVERTISE_START_FAST\n");
    ...
    {
      APP_DBG_MSG("PROC_GAP_PERIPH_ADVERTISE_START_LP\n");
    ...
    {
      APP_DBG_MSG("PROC_GAP_PERIPH_ADVERTISE_STOP\n");
      paramC = APP_BLE_IDLE;
    ...
    case AD_TYPE_MANUFACTURER_SPECIFIC_DATA:
      {
        ...
        p_adv_data[i+6] = FW_ID_DOORLOCK; /* FW ID */
