...
set boot_lock=-ob BOOT_LOCK=0
set default_ob1=-ob SRAM2_RST=0 NSBOOTADD0=0x100000 NSBOOTADD1=0x17f200 SECBOOTADD0=%secbootadd0% nSWBOOT0=1 SECWM1_PSTRT=0 SECWM1_PEND=%flashsectnbr%
...
IF %errorlevel% NEQ 0 goto :error
echo Set BOOT_LOCK to 0 before modifying other boot option
%stm32programmercli% %connect_no_reset% %boot_lock%
IF %errorlevel% NEQ 0 goto :error
